    ...
    return (
        <IonPage>
            ...
            <IonContent fullscreen>
                    ...
                    <IonList>
                        <div className="row g-3 was-validated ">
                            ...
                            <div className="col-sm-6">
                                ...
                                <select value={tipovisita} onInput={tipovisitafun} className="form-control form-control-sm" id="pregunta2_3" aria-describedby="validationServer04Feedback" required>
                                    <option value=""> SELECCIONE </option><option value="15"> ACTA DE NACIMIENTO </option><option value="1"> CÉDULA DE CIUDADANÍA </option><option value="4"> CÉDULA DE EXTRANJERÍA </option><option value="8"> CÉDULA VENEZOLANA </option><option value="12"> DNI -DOCUMENTO NACIONAL DE IDENTIDAD </option><option value="10"> NES-NÚMERO ESTABLECIDO POR LA SECRETARÍA DE EDUCACIÓN </option><option value="9"> NIT: NÚMERO ÚNICO DE IDENTIFICACIÓN TRIBUTARIA </option><option value="13"> NO TIENE -NO POSEE DOCUMENTOS DE IDENTIDAD </option><option value="11"> NUIP: NÚMERO ÚNICO DE IDENTIFICACIÓN PERSONAL </option><option value="5"> PASAPORTE </option><option value="6"> PET-PERMISO ESPECIAL DE PERMANENCIA </option><option value="7"> PPT-PERMISO POR PROTECCIÓN TEMPORAL </option><option value="3"> REGISTRO CIVIL </option><option value="16"> SALVOCONDUCTO </option><option value="14"> SIN DATO - NO INFORMA SOBRE DOCUMENTO DE IDENTIDAD </option><option value="2"> TARJETA DE IDENTIDAD </option>
                                </select>
                            </div>
                            <div className="col-sm-6">
                ...
                <div><IonButton color="success">Guardar</IonButton><IonButton routerLink={`/tabs/tab9/${params.ficha}`}>Siguiente</IonButton></div>
