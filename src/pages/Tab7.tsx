...
<div className="row g-3 was-validated ">
          ...
          <option value=""> SELECCIONE </option><option value="1"> 1 Popular </option><option value="10"> 10 La Candelaria </option><option value="11"> 11 Laureles Estadio </option><option value="12"> 12 La América </option><option value="13"> 13 San Javier </option><option value="14"> 14 El Poblado </option><option value="15"> 15 Guayabal </option><option value="16"> 16 Belén </option><option value="17"> 17 Ciudadela </option><option value="2"> 2 Santa Cruz </option><option value="120"> 20 - FUERA DE MEDELLIN </option><option value="121"> 21 - FUERA DE ANTIOQUIA </option><option value="3"> 3 Manrique </option><option value="4"> 4 Aranjuez </option><option value="5"> 5 Castilla </option><option value="50"> 50 Palmitas </option><option value="6"> 6 Doce de Octubre </option><option value="60"> 60 San Cristóbal </option><option value="7"> 7 Robledo </option><option value="70"> 70 Altavista </option><option value="8"> 8 Villa Hermosa </option><option value="80"> 80 San Antonio de Prado </option><option value="9"> 9 Buenos Aires </option><option value="90"> 90 Santa Elena </option><option value="91"> Otro </option>
          </select>
          </div>
          <div className="col-sm">
  ...
  <br />  
    ...
    <div><IonButton color="success" onClick={enviar}>Guardar</IonButton><IonButton routerLink={`/tabs/tab8/${params.ficha}`}>Siguiente</IonButton></div>
